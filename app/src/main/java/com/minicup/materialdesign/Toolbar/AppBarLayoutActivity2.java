    ...
    private void initRecyclerView() {
        ...
        mRecyclerView.setAdapter(new RecyclerView.Adapter() {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                View inflate = LayoutInflater.from(AppBarLayoutActivity2.this).inflate(android.R.layout.simple_list_item_1, null);
                return new AppBarLayoutActivity2.VH(inflate);
            }

            @Override
            public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
                ((AppBarLayoutActivity2.VH)holder).itemView.setText(mData[position]);
            }
